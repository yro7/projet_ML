...
Pour évaluer la capacité de notre système à gérer une complexité de classification supérieure, nous avons introduit un nouveau jeu de données personnel synthétique (\texttt{sons\_ia}) composé de \textbf{130 signaux audio} (13 classes distinctes $\times$ 10 exemples par classe) échantillonnés à 16\,kHz :
\begin{center}
