...
\textbf{Perspectives :} Bien que nous ayons initié l'évaluation sur 13 classes (avec des sons de synthèse d'IA) et étudié la robustesse face au bruit, l'évaluation sur un jeu de données humain multi-locuteurs à 13 classes ainsi que l'utilisation de techniques plus complexes d'augmentation de données audio (comme le pitch shifting ou le time stretching) permettraient d'étendre encore la robustesse de ces modèles dans des conditions réelles de vol.
